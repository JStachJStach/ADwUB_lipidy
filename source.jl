...
kalibracja[!, :próbka] = [0, 50, 100, 200, 300, 400, 500]
...
ax = Axis(fig[1, 1], title="grupa1 sesja1", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], ylabel="próbka", ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
wykres(ax, kalibracja[:, :próbka], kalibracja[:, :g1_s1], test[:, :g1_s1])
ax = Axis(fig[1, 2], title="grupa1 sesja2", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
wykres(ax, kalibracja[:, :próbka], kalibracja[:, :g1_s2], test[:, :g1_s2])
ax = Axis(fig[2, 1], title="grupa2 sesja1", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], ylabel="próbka", xlabel="absorbancja względna", ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
wykres(ax, kalibracja[:, :próbka], kalibracja[:, :g2_s1], test[:, :g2_s1])
ax = Axis(fig[2, 2], title="grupa2 sesja2", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], xlabel="absorbancja względna", ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
wykres(ax, kalibracja[:, :próbka], kalibracja[:, :g2_s2], test[:, :g2_s2])
ax = Axis(fig[1, 3], title="grupa1 średnia", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
wykres(ax, kalibracja[:, :próbka], kalibracja[:, :g1_średnia_wiersze], vcat(test[:, :g1_s1], test[:, :g1_s2]))
ax = Axis(fig[2, 3], title="grupa2 średnia", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], xlabel="absorbancja względna", ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
...
ax = Axis(fig[1, 1], title="grupa1 seria1", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], ylabel="próbka", ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
wykres(ax, kalibracja[:, :próbka], bez_punktów[:, :g1_s1], test[:, :g1_s1])
ax = Axis(fig[1, 2], title="grupa1 seria2", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
wykres(ax, kalibracja[:, :próbka], bez_punktów[:, :g1_s2], test[:, :g1_s2])
ax = Axis(fig[2, 1], title="grupa2 seria1", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], xlabel="absorbancja względna", ylabel="próbka", ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
wykres(ax, kalibracja[:, :próbka], bez_punktów[:, :g2_s1], test[:, :g2_s1])
ax = Axis(fig[2, 2], title="grupa2 seria2", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], xlabel="absorbancja względna", ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
...
fig = Figure()
ax = Axis(fig[1, 1], title="Średnie wartości pomiarów dla krzywej kalibracyjnej we wszystkich seriach.\nUwzględniono również średnie z testowych dla grupy2 oraz grupy1 serii1", backgroundcolor=bkg_col, yticks=kalibracja[:, :próbka], ylabel="próbka", ytickformat=v -> ["$(v)μl" for v in kalibracja[:, :próbka]])
